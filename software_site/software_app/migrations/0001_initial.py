    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pile', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='software_app.pile')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='software_app.user')),
            ],
        ),
    ]
